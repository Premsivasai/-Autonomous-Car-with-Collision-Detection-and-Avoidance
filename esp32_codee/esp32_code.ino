...
up from 15
// seconds to process single frame. Face Detection is ENABLED if PSRAM
is enabled as well
// ===================
// Select camera model
// ===================
...
//1. chooseing better data transfercable.
//2. installing the drivers that are requried.
//3. we rectified error in the code
WiFi.begin(ssid, password);
 WiFi.setSleep(true);
